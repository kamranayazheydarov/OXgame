...
try:
    ...
    img = None
    print("Warning: 'clear.png' not found. Some features may not work correctly.")
...
def changephato():
    ...
    if x == 1:
        ...
        blackb1 += 1
        if blackb1 >= 2:
            black_button_1.config(image=img, state=DISABLED) if img else black_button_1.config(state=DISABLED)
    elif x == 2:
        playsound('sound.mp3')
        black_button_2.config(image=new_image2_2)
        blackb2 += 1
        if blackb2 >= 2:
            black_button_2.config(image=img, state=DISABLED) if img else black_button_2.config(state=DISABLED)
    elif x == 3:
        playsound('sound.mp3')
        black_button_3.config(image=new_image3_2)
        blackb3 += 1
        if blackb3 >= 2:
            black_button_3.config(image=img, state=DISABLED) if img else black_button_3.config(state=DISABLED)
    elif x == 4:
        playsound('sound.mp3')
        blue_button_4.config(image=new_image4_2)
        blueb1 += 1
        if blueb1 >= 2:
            blue_button_4.config(image=img, state=DISABLED) if img else blue_button_4.config(state=DISABLED)
    elif x == 5:
        playsound('sound.mp3')
        blue_button_5.config(image=new_image5_2)
        blueb2 += 1
        if blueb2 >= 2:
            blue_button_5.config(image=img, state=DISABLED) if img else blue_button_5.config(state=DISABLED)
    elif x == 6:
        playsound('sound.mp3')
        blue_button_6.config(image=new_image6_2)
        blueb3 += 1
        if blueb3 >= 2:
            blue_button_6.config(image=img, state=DISABLED) if img else blue_button_6.config(state=DISABLED)

# --------------------------- ---------------- BLACK PLAYER --------------------------------

resized_image= img_black.resize((100,150), Image.LANCZOS)
new_image= ImageTk.PhotoImage(resized_image)

resized_image2= img_black.resize((60,90), Image.LANCZOS)
new_image2= ImageTk.PhotoImage(resized_image2)

resized_image3= img_black.resize((20,30), Image.LANCZOS)
new_image3= ImageTk.PhotoImage(resized_image3)

img_black2= (Image.open("black2.png"))
resized_image1_2= img_black2.resize((100,150), Image.LANCZOS)
new_image1_2= ImageTk.PhotoImage(resized_image1_2)

resized_image2_2= img_black2.resize((60,90), Image.LANCZOS)
new_image2_2= ImageTk.PhotoImage(resized_image2_2)

resized_image3_2= img_black2.resize((20,30), Image.LANCZOS)
...
resized_image4= img_blue.resize((100,150), Image.LANCZOS)
new_image4= ImageTk.PhotoImage(resized_image4)


resized_image5= img_blue.resize((60,90), Image.LANCZOS)
new_image5= ImageTk.PhotoImage(resized_image5)


resized_image6= img_blue.resize((20,30), Image.LANCZOS)
...
resized_image4_2= img_blue2.resize((100,150), Image.LANCZOS)
new_image4_2= ImageTk.PhotoImage(resized_image4_2)

resized_image5_2= img_blue2.resize((60,90), Image.LANCZOS)
new_image5_2= ImageTk.PhotoImage(resized_image5_2)

resized_image6_2= img_blue2.resize((20,30), Image.LANCZOS)
